...
class LoginForm extends Component {
    ...
    onButtonPress = () => {
        const {username, lokasinf, nomornf, email, password,image } = this.props;
        this.props.registUser({ username, lokasinf, nomornf,image, email, password });
    ...
    renderFormLogin =()=>{
        ...
        return(
            ...
            <View>
            <Text style={styles.titleTextStyle}>Daftar Disini</Text>
            <Card>
                <RegistInput/>    
                <CardSection>
                <Input
...
const mapStateToProps = (state) => {
    ...
    return { username, lokasinf, nomornf,email, password, error, loading, user,checkedAuth ,image};
};

export default connect(mapStateToProps, { emailChanged, passwordChanged, registUser })(LoginForm);